import {connectViaPublicDID, getCredentialsBySchema} from "../aries-wrapper/utils";
import {subjectVoteSchema} from "../schemas";
import {SubjectProposalType, SubjectVoteSchema} from "@project-types";
import {Config} from "../config";
import {isCredentialRevoked, presentProof, proposeProof, rejectProof} from "../aries-wrapper";
